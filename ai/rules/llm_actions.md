...
YOU MUST OUTPUT AS A TEXT FILE. A COPY PASTABLE TEXT FILE. DO NOT PROVIDE ME PLAIN TEXT. PLEASE PROVIDE ME A FORMAT THAT IS COPY PASTABLE INTENDED FOR A TEXT FILE.